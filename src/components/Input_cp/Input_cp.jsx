...
const Input_cp = (props) => {
  ...
  return (
    <>
      ...
      <Input placeholder={props.placeholder} className='rounded-lg font-semibold' onChange={handleChange} allowClear value={props.value} disabled={props.disabled} onKeyDown={props.KeyDown} />
